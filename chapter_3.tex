...
A survey was conducted to compare the finetuned model to the base model to determine if the finetuning was effective. A total of participants were involved in the survey, and the survey was conducted online using Google Forms. The survey asked the participants to pick which of the following sentences is the more accurate translation of the given sentence. The order in which sentences from the two models were shown was randomly selected to avoid bias.
