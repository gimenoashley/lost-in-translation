...
A more specific translation tool developed using language models use in many digital platforms can be used to bridge this divide.
...
%\subsection{Scope and Limitations of the Research} %for improvement
...
%\subsection{Significance of the Research} %for improvement
