...
However, no such tool exists for slang translation of Generation Alpha, which arguably has the most diverse slang compared to other generations.
The creation of this tool will allow translation of such texts into formal sentences and help with bridging the generational divide between them and older people, especially teachers. 
...
\label{sec:scope}
This study will focus on the usage of internet slang by Filipino Generation Z, with an emphasis on English language since it is widely used on different digital platforms such as social media.
